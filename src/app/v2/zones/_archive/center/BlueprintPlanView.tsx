/**
 * BlueprintPlanView.tsx — Blueprint Plan Strategique (ex-RD.7 Mon Blueprint)
 ...
 * Template de reference pour la section Blueprint de tous les utilisateurs
 */
  ...
  const team = [
    ...
    },
    {
      ...
      actions: [
        ...
        "CSOB Sophie: Qualification Orbit9 + strategies",
        "COOB Olivier: Operations + routines + SLA",
        "CLOB Louise: Loi 25 + ToS + guides legaux",
...
export function BlueprintPlanView() {
