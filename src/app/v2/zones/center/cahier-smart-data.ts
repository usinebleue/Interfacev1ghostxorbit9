...
export const BOT_COLORS: Record<string, {
  ...
  BCC: { bg: "bg-cyan-600", bgLight: "bg-cyan-50", text: "text-cyan-700", border: "border-cyan-400", ring: "ring-cyan-300", dot: "bg-cyan-500", emoji: "\u{1F4E2}", name: "Catherine", role: "CCO", avatar: "/agents/cco-catherine.png" },
