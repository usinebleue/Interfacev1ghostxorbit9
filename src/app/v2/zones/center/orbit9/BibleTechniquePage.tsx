...
const BOTS_DATA = [
  ...
  {
    code: "CTOB", name: "Thierry", role: "CTO", color: "violet",
  ...
  {
    code: "CFOB", name: "Francois", role: "CFO", color: "emerald",
  ...
  {
    code: "CMOB", name: "Martine", role: "CMO", color: "pink",
  ...
  {
    code: "CSOB", name: "Sophie", role: "CSO", color: "red",
  ...
  {
    code: "CPOB", name: "Fabien", role: "CPO", color: "slate",
  ...
  {
    code: "CROB", name: "Raphael", role: "CRO", color: "amber",
  ...
  {
    code: "CLOB", name: "Louise", role: "CLO", color: "indigo",
...
const BACKEND_MODULES = [
  ...
  { name: "agents.py", description: "6 C-Level agents (CEOB/CTOB/CFOB/CMOB/CSOB/COOB) + 8+1 reflection modes", category: "agents", lines: "~600" },
