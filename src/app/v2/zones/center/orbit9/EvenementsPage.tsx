  ...
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-4 gap-3">
        <Card className="p-0 overflow-hidden"><div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-rose-600 to-rose-500"><Calendar className="h-4 w-4 text-white" /><span className="text-sm font-bold text-white">Prochain</span></div><div className="px-3 py-2"><div className="text-2xl font-bold text-rose-600">15 mars</div><div className="text-[10px] text-gray-500">Kickoff Pionniers</div></div></Card>
        <Card className="p-0 overflow-hidden"><div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-amber-600 to-amber-500"><Star className="h-4 w-4 text-white" /><span className="text-sm font-bold text-white">Frequence (Or)</span></div><div className="px-3 py-2"><div className="text-2xl font-bold text-amber-600">4x/an</div><div className="text-[10px] text-gray-500">Trimestriel + diners prives</div></div></Card>
        <Card className="p-0 overflow-hidden"><div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-indigo-600 to-indigo-500"><Rocket className="h-4 w-4 text-white" /><span className="text-sm font-bold text-white">Grande Offensive</span></div><div className="px-3 py-2"><div className="text-2xl font-bold text-indigo-600">Sprint D</div><div className="text-[10px] text-gray-500">Expansion regionale</div></div></Card>
        <Card className="p-0 overflow-hidden"><div className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-emerald-600 to-emerald-500"><Star className="h-4 w-4 text-white" /><span className="text-sm font-bold text-white">Participants</span></div><div className="px-3 py-2"><div className="text-2xl font-bold text-emerald-600">9</div><div className="text-[10px] text-gray-500">Pionniers confirmes</div></div></Card>
      </div>
