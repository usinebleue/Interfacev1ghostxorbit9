...
const BOT_INFO: Record<string, { label: string; short: string; gradient: string }> = {
  ...
  BCF: { label: "Francois", short: "CFO", gradient: "from-emerald-600 to-emerald-500" },
  ...
  BHR: { label: "Helene", short: "CHRO", gradient: "from-teal-600 to-teal-500" },
  BIO: { label: "Ines", short: "CINO", gradient: "from-rose-600 to-rose-500" },
  BRO: { label: "Raphael", short: "CRO", gradient: "from-amber-600 to-amber-500" },
  BLE: { label: "Louise", short: "CLO", gradient: "from-indigo-600 to-indigo-500" },
  BSE: { label: "Sebastien", short: "CISO", gradient: "from-gray-600 to-gray-500" },
};
...
function TabEquipe() {
  const team = [
    ...
    },
    {
      ...
      actions: [
        "BCF Francois: Stripe billing + TimeTokens + pricing",
        ...
        "BSE Sebastien: Audit securite + monitoring",
        "BRO Raphael: Scout ecosysteme QC + cellules",
        "BIO Ines: Oracle9 sondeur + predictions",
      ],
    },
  ];
