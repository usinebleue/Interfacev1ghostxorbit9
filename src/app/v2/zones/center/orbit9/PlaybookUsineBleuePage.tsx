...
const BOT_INFO: Record<string, { label: string; short: string; gradient: string }> = {
  ...
  CFOB: { label: "François", short: "CFO", gradient: "from-emerald-600 to-emerald-500" },
  ...
  CROB: { label: "Raphaël", short: "CRO", gradient: "from-amber-600 to-amber-500" },
...
function TabEquipe() {
  const team = [
    ...
    },
    {
      ...
      actions: [
        "CFOB François: Stripe billing + TimeTokens + pricing",
        "CMOB Martine: Marketing 360 + demos + Help Center",
        ...
        "CROB Raphaël: Scout ecosysteme QC + cellules",
