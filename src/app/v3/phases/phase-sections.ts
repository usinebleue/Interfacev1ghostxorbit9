...
/** Actions communes ajoutées à TOUTES les sections */
const ACTION_EPINGLER: SectionAction = { label: "Épingler", icon: Pin, promptTemplate: "", variant: "default" };
const ACTION_FUSIONNER: SectionAction = { label: "Fusionner", icon: Layers, promptTemplate: "Fusionne cette section avec les autres sections cristallisées pour créer une synthèse cohérente: {content}", variant: "default" };
